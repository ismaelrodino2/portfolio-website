  ...
  return (
    <header className="flex flex-col lg:flex-row gap-8">
      <div className="h-36 w-44">
        <Link href="https://ismaelrodino.vercel.app">
          <a>
            <Image
            quality={100}
              priority
              width={144}
              height={144}
              className="rounded object-center object-fill"
              alt="Ismael Rodino's profile picture"
              src="/profile.jpg"
            />
          </a>
        </Link>
      ...
      <div className="flex flex-col w-full gap-8 lg:gap-4 lg:h-36 lg:justify-between">
        <div className="w-full flex flex-col gap-8 justify-between lg:items-center lg:flex-row">
          <div>
            <h1 className="text-4xl font-semibold">Ismael Rodino</h1>
            <h2 className="text-xl">
              {t("title")}
              <span className="hidden lg:inline">{t("exp")}</span>
            </h2>
          </div>
            ...
            <div className="bg-gray-100 flex items-center justify-center ">
              <div className="flex space-x-2">
                ...
                <button
                  ...
                  onClick={async () => await setLanguage("no")}
                >
                  NO
                </button>
              </div>
        ...
        <div className="grid lg:grid-rows-2 lg:mt-0 lg:grid-cols-3 gap-2 w-full">
          <div className="flex gap-2 items-center">
            ...
            <a href="tel:+5551985047712">+55 51 98504-7712</a>
          </div>
          <div className="flex gap-2 items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="mailto:ismael.rodino@hotmail.com">
              ismael.rodino@hotmail.com
            </a>
          </div>
          <div className="flex gap-2 items-center">
            <svg
          ...
          <div className="flex gap-2 items-center">
            ...
            <a
              href={
                lang === "en"
                  ? "https://www.linkedin.com/in/ismael-tavares/"
                  : "https://www.linkedin.com/in/ismael-tavares/?locale=pt_BR"
              }
              target="_blank"
              rel="noopener"
            >
              linkedin.com/in/ismael-tavares
            </a>
          </div>
          <div className="flex gap-2 items-center">
            <svg
